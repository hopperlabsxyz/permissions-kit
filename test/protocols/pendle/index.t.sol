...
import { IActionAddRemoveLiqV3 } from "@test/interfaces/IActionAddRemoveLiqV3.sol";
...
contract PendleTest is BaseTest {
    ...
    function _loadPermissions(string memory path) internal {
        ...
        transfer = abi.decode(
            vm.parseJson(json, "$.pendle.base.depositToken"),
            (bytes[])
        );
    }
}

contract depositToken is PendleTest {
